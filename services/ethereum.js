...
const { deriveChildPublicKey, najPublicKeyStrToUncompressedHexPoint, uncompressedHexPointToEvmAddress } = require('../services/kdf');
...
class Ethereum {
  constructor(chain_rpc, chain_id) {
    ...
    this.provider = new providers.JsonRpcProvider(chain_rpc);
